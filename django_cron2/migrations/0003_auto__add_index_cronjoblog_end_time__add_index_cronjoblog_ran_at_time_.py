...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_index(u'django_cron2_cronjoblog', ['end_time'])

        # Adding index on 'CronJobLog', fields ['ran_at_time', 'is_success', 'code']
        db.create_index(u'django_cron2_cronjoblog', ['ran_at_time', 'is_success', 'code'])

        # Adding index on 'CronJobLog', fields ['ran_at_time', 'start_time', 'code']
        db.create_index(u'django_cron2_cronjoblog', ['ran_at_time', 'start_time', 'code'])

        # Adding index on 'CronJobLog', fields ['start_time', 'code']
        db.create_index(u'django_cron2_cronjoblog', ['start_time', 'code'])


    def backwards(self, orm):
        # Removing index on 'CronJobLog', fields ['start_time', 'code']
        db.delete_index(u'django_cron2_cronjoblog', ['start_time', 'code'])

        # Removing index on 'CronJobLog', fields ['ran_at_time', 'start_time', 'code']
        db.delete_index(u'django_cron2_cronjoblog', ['ran_at_time', 'start_time', 'code'])

        # Removing index on 'CronJobLog', fields ['ran_at_time', 'is_success', 'code']
        db.delete_index(u'django_cron2_cronjoblog', ['ran_at_time', 'is_success', 'code'])

        # Removing index on 'CronJobLog', fields ['end_time']
        db.delete_index(u'django_cron2_cronjoblog', ['end_time'])


    models = {
        u'django_cron2.cronjoblog': {
