...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'WebCamera.internal_url'
        db.add_column('lighting_webcamera', 'internal_url',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'WebCamera.internal_url'
        db.delete_column('lighting_webcamera', 'internal_url')
    ...
    models = {
        ...
        'lighting.webcamera': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'internal_url': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True'}),
